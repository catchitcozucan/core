...
public class BpmSchemeElementDescriptor extends BaseDomainObject implements Comparable<BpmSchemeElementDescriptor> {
    ...
    public static final String STEP_METHOD_NAME_PROPERTY = "stepMethodName";
    ...
    public static final String IN_YOUR_STATUS_ENUM_STATE_S_THE_STATUS_UPON_FAILURE_IS_MISSING_IN_YOUR_GENERATED_STEP_THIS_IS_THE_LINK_TO_THE_CONNECTED_SUCCESS_STATE = "In your status enum, state %s the statusUponFailure is missing in your generated step - this is the link to the connected success state";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_THE_STATUS_UPON_FAILURE_IS_MISSING_IN_YOUR_GENERATED_STEP_THIS_IS_THE_LINK_TO_THE_CONNECTED_SUCCESS_STATE = "In your status enum, state at index %n the statusUponFailure is missing in your generated step - this is the link to the connected success state";
    ...
    public static final String IN_YOUR_STATUS_ENUM_STATE_S_THE_STATUS_UPON_FAILURE_IS_MISSING_IN_YOUR_GENERATED_STEP_THIS_IS_THE_LINK_TO_THE_CONNECTED_FAILURE_STATE = "In your status enum, state %s the statusUponFailure is missing in your generated step - this is the link to the connected failure state";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_THE_STATUS_UPON_FAILURE_IS_MISSING_IN_YOUR_GENERATED_STEP_THIS_IS_THE_LINK_TO_THE_CONNECTED_FAILURE_STATE = "In your status enum, state at index %n the statusUponFailure is missing in your generated step - this is the link to the connected failure state";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_UNKNOWN_THE_DESCRIPTION_IS_MISSING_IN_YOUR_GENERATED_STEP_WE_CONSIDER_THIS_YOUR_TASK_NAM = "In your status enum, state at index [UNKNOWN] the description is missing in your generated step - we consider this your task nam";
    public static final String IN_YOUR_STATUS_ENUM_STATE_S_THE_DESCRIPTION_IS_MISSING_IN_YOUR_GENERATED_STEP_WE_CONSIDER_THIS_YOUR_TASK_NAME = "In your status enum, state %s the description is missing in your generated step - we consider this your task name";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_THE_DESCRIPTION_IS_MISSING_IN_YOUR_GENERATED_STEP_WE_CONSIDER_THIS_YOUR_TASK_NAME = "In your status enum, state at index %n the description is missing in your generated step - we consider this your task name";
    ...
    public static final String IN_YOUR_STATUS_ENUM_STATE_S_SHOULD_HAVE_A_PREVIOUS_STATE_OR_IF_IT_S_THE_FIRST_STATE_WE_SHOULD_UNDERSTAND_THAT_IT_S_THE_PRE_PROCESS_STATE = "In your status enum, state %s should have a previous state OR if it's the first state, we should understand that it's the pre-process state";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_SHOULD_HAVE_A_PREVIOUS_STATE_OR_IF_IT_S_THE_FIRST_STATE_WE_SHOULD_UNDERSTAND_THAT_IT_S_THE_PRE_PROCESS_STATE = "In your status enum, state at index %n should have a previous state OR if it's the first state, we should understand that it's the pre-process state";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_LACKS_A_NAME = "In your status enum, state at index %n lacks a name";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_LACKS_A_PROCESS_NAME = "In your status enum, state at index %n lacks a processName";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_YOUR_POSITIVE_OP_FAILURE = "In your status enum, state at index %n your positive state does NOT have an even index. This means that your statues are NOT lined up in the suppported order [ INITIAL_STATE, FAILURE_FST_OP, FST_OP_SUCCESSFULL, SND_OP_FAILURE.. ]";
