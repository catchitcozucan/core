...
public class BpmSchemeElementDescriptor extends BaseDomainObject implements Comparable<BpmSchemeElementDescriptor> {
    ...
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_THE_DESCRIPTION_IS_MISSING_IN_YOUR_GENERATED_STEP_WE_CONSIDER_THIS_YOUR_TASK_NAME = "In your status enum, state at index %d the description is missing in your generated step - we consider this your task name";
    ...
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_LACKS_A_NAME = "In your status enum, state at index %d lacks a name";
    public static final String IN_YOUR_STATUS_ENUM_STATE_AT_INDEX_N_LACKS_A_PROCESS_NAME = "In your status enum, state at index %d lacks a processName";
