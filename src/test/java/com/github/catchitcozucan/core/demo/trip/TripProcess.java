...
public class TripProcess extends ProcessBase<TripSubject> {
    ...
    public static final java.util.List<java.lang.String> FAIL_STATES = java.util.Arrays.asList(
        com.github.catchitcozucan.core.demo.trip.TripStatus.Status.HOTEL_NOT_CONFIRMED.name(),
        com.github.catchitcozucan.core.demo.trip.TripStatus.Status.CAR_NOT_CONFIRMED.name(),
        com.github.catchitcozucan.core.demo.trip.TripStatus.Status.FLIGHT_NOT_CONFIRMED.name()
    );
