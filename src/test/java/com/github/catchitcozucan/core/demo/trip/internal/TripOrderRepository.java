...
public class TripOrderRepository implements PersistenceService<TripSubject> {
    ...
    private List<TripSubject> orders;
    ...
    public List<TripSubject> load() {
        List<TripSubject> ordersToLoad = new ArrayList<>();
    ...
    @Override
    public void save(TripSubject subject) {
        SerializationService.getInstance().perform(SerializationService.OP.SAVE, subject);
    }

    @Override
    public Stream<TripSubject> provideSubjectStream() {
        return TripOrderRepository.getInstance().load().stream();
    }

    @Override
    public Stream<TripSubject> provideStateFilteredSubjectStream() {
